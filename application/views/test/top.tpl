...
<h3>掲示板関連</h3>
<ul>
    <li><a href="formGroupMessage">グループ掲示板へメッセージ追加</a></li>
    <li><a href="showGroupMessage">グループ掲示板表示</a></li>
    <li><a href="formUserMessage">ユーザ掲示板へメッセージ追加</a></li>
    <li><a href="showUserMessage">ユーザ掲示板表示</a></li>
</ul>
